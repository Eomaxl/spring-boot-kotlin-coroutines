package com.eomaxl.springkotlincorountines.blocking
...
class BlockingConfig {
    ...
    private val PROPERTY_NAME_DATABASE_PLATFORM = "spring.datasource.platform"
    ...
    fun entityManagerFactory(dataSource: DataSource, additionalProperties: Properties): LocalContainerEntityManagerFactoryBean =
        LocalContainerEntityManagerFactoryBean().apply {
            ...
            setPackagesToScan("com.eomaxl.springkotlincorountines.blocking")
